...
- (void)centerButtonPressed {
    ...
    [self.centerButton setImage:[UIImage imageNamed:@"plus_icon"] forState:UIControlStateNormal];
...
- (void)didTapBarItem:(id)sender {
    ...
    YALTabBarItem *item = [self.allBarItems objectAtIndex:index];
    [self.centerButton setImage:item.itemImage forState:UIControlStateNormal];
