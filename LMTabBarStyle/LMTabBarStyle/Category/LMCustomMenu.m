...
@interface LMCustomMenu()
@property (nonatomic, assign) CGPoint origin;
@property (nonatomic, assign) CGFloat rowHeight;
@end
@implementation LMCustomMenu
...
- (instancetype)initWithDataArr:(NSArray *)dataArr origin:(CGPoint)origin width:(CGFloat)width rowHeight:(CGFloat)rowHeight
{
    ...
    if (self) {
        ...
        [_tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"LMCustomMenu"];
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"LMCustomMenu"];
...
{
    if([self.delegate respondsToSelector:@selector(LMCustomMenu:didSelectRowAtIndexPath:)]){
        [self.delegate LMCustomMenu:tableView didSelectRowAtIndexPath:indexPath];
    }
